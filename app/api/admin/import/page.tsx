...
export default function AdminImportPage() {
  ...
  return (
    <main style={{ maxWidth: 900, margin: "0 auto", padding: 16, fontFamily: "system-ui" }}>
      ...
      <p>
        Paste your admin token, then upload CSV or paste CSV content. This page stores the token in session storage for
        this tab only.
      </p>
      ...
      <h2>Upload media</h2>
      <p>
        Use these to upload audio and images to Supabase Storage. Copy the returned <code>path</code> into your CSV as{" "}
        <code>audio_path</code> or <code>image_path</code>.
      </p>
      ...
      <div style={{ display: "grid", gap: 10 }}>
        <input
          ...
          placeholder="Optional target path, eg audio/warmup-001.mp3 (leave blank to auto-name)"
          style={inputStyle}
        />
      ...
      <div style={{ display: "grid", gap: 10 }}>
        <input
          ...
          placeholder="Optional target path, eg images/pic-001.png (leave blank to auto-name)"
          style={inputStyle}
        />
