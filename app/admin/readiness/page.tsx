...
import { RoundReadinessDashboard } from "@/components/admin/RoundReadinessDashboard"
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8">
      <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="text-2xl font-semibold">Admin Round Readiness</div>
          <div className="text-sm text-muted-foreground">
            See which questions are ready for standard rounds, Quickfire, and short-audio Quickfire.
          </div>
        </div>
